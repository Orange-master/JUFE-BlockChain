...
+ 比萨：国家渠道的仲裁外包
+ Bolt：去中心化货币的匿名支付渠道
+ elto：比特币的简单 Layer2 协议
+ Revive：重新平衡链下支付网络
+ 精灵和状态通道：比闪电更快的支付网络
+ Flare：闪电网络中的一种路由方法
+ SoK：链下交易
+ 反事实：广义状态通道
+ 用于区块链可扩展性和互操作性的匿名多跳锁
+ 比特币闪电网络：可扩展的链下即时支付
+ 带有断言的两方状态通道
+ 通用状态通道网络
### Privacy
+ CoinParty：比特币的安全多方混合
+ 完整的比特币交易图的定量分析
+ 开关承诺：机密交易的安全开关
+ Monero 区块链中可链接性的实证分析
+ 机密资产
+ Blindcoin 盲目的、负责任的比特币混合
+ 规定：比特币交易所的隐私保护偿付能力证明
+ 增加比特币的匿名性
+ 在许可区块链中通过 TumbleBit 进行可转移匿名支付
+ 网络信息能否促进比特币中的地址聚类？
+ 加密笔记 v2.0
+ 混合机密交易：比特币的综合交易隐私
+ 比特币中数据驱动的去匿名化
+ 盲签合约：匿名的链上和链下比特币交易
+ 恐惧海盗罗伯茨是如何获得和保护他的比特币财富的？
+ 比特币交易定向超图中的交换模式挖掘
+ Hawk：密码学和隐私保护智能合约的区块链模型
+ Mixcoin：比特币匿名与负责任的混合
+ Ration Zero：具有永久匿名性的 Zerocoin 的经济安全
### Proof of work
+ Hashcash - 拒绝服务反措施
+ Cuckoo Cycle：内存绑定图论工作证明
+ 通过处理或打击垃圾邮件定价
+ Permacoin：将比特币工作重新用于数据保存
+ PieceWork：工作证明的广义外包控制
### Sidechains, Higher layer and Scalability
+ Bitcoin-NG：可扩展的区块链协议
+ 面向服务的区块链分片
+ 具有次线性复杂性的工作证明证明
+ 关于比特币交易的延展性
+ FlyClient：加密货币的超轻客户端
+ 改进经过身份验证的动态字典，并应用于加密货币
+ 工作量证明侧链
+ 使用挂钩侧链实现区块链创新
+ 权益证明侧链
+ 工作量证明的非交互式证明
+ 开放区块链的安全分片协议
+ ForkBase：区块链和可分叉应用程序的高效存储引擎
+ 关于扩展去中心化区块链
### Smart Contracts
+ 具有最大选民隐私的董事会投票智能合约
+ Town crier：用于智能合约的经过身份验证的数据馈送
+ 通过比特币存款进行公平的两方计算
+ 下一代智能合约和去中心化应用平台
+ 比特币上的恒定存款多方彩票
...
+ 通过集体签名增强比特币的安全性和性能，具有强一致性
### Survey, Sociological & Anthropological
+ 硬币的另一面：比特币安全和隐私的用户体验
+ 从技术政策角度看加密货币：政策问题和技术方向
+ 设计类似比特币的社区货币的问题
+ 比特币 OP_RETURN 元数据分析
+ 比特币市场潜力指数
### Wallets
